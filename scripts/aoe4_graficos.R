...
setwd("/home/matheus/Code/fac/prob/trab/graficos/tudo")
aoe4_graficos(aoe4, prefix="global_")
aoe4_graficos(aoe4_africa, prefix="africa_")
aoe4_graficos(aoe4_asia, prefix="asia_")
aoe4_graficos(aoe4_europe, prefix="europe_")
aoe4_graficos(aoe4_middleeast, prefix="middleeast_")
aoe4_graficos(aoe4_northamerica, prefix="northamerica_")
aoe4_graficos(aoe4_southamerica, prefix="southamerica_")
aoe4_graficos(aoe4_oceania, prefix="oceania_")


#q3_elo


setwd("/home/matheus/Code/fac/prob/trab/graficos/q3_elo")
aoe4_graficos(aoe4_q3_elo, prefix="global_")
aoe4_graficos(africa_q3_elo, prefix="africa_")
aoe4_graficos(asia_q3_elo, prefix="asia_")
aoe4_graficos(europe_q3_elo, prefix="europe_")
aoe4_graficos(middleeast_q3_elo, prefix="middleeast_")
aoe4_graficos(northamerica_q3_elo, prefix="northamerica_")
aoe4_graficos(southamerica_q3_elo, prefix="southamerica_")
aoe4_graficos(oceania_q3_elo, prefix="oceania_")


#d9_elo


setwd("/home/matheus/Code/fac/prob/trab/graficos/d9_elo")
aoe4_graficos(aoe4_d9_elo, prefix="global_")
aoe4_graficos(africa_d9_elo, prefix="africa_")
aoe4_graficos(asia_d9_elo, prefix="asia_")
aoe4_graficos(europe_d9_elo, prefix="europe_")
aoe4_graficos(middleeast_d9_elo, prefix="middleeast_")
aoe4_graficos(northamerica_d9_elo, prefix="northamerica_")
aoe4_graficos(southamerica_d9_elo, prefix="southamerica_")
aoe4_graficos(oceania_d9_elo, prefix="oceania_")


#q3_winrate


setwd("/home/matheus/Code/fac/prob/trab/graficos/q3_winpercent")
aoe4_graficos(aoe4_q3_wr, prefix="global_")
aoe4_graficos(africa_q3_winpercent, prefix="africa_")
aoe4_graficos(asia_q3_winpercent, prefix="asia_")
aoe4_graficos(europe_q3_winpercent, prefix="europe_")
aoe4_graficos(middleeast_q3_winpercent, prefix="middleeast_")
aoe4_graficos(northamerica_q3_winpercent, prefix="northamerica_")
aoe4_graficos(southamerica_q3_winpercent, prefix="southamerica_")
aoe4_graficos(oceania_q3_winpercent, prefix="oceania_")


#d9_winrate


setwd("/home/matheus/Code/fac/prob/trab/graficos/d9_winpercent")
aoe4_graficos(aoe4_d9_wr, prefix="global_")
aoe4_graficos(africa_d9_winpercent, prefix="africa_")
aoe4_graficos(asia_d9_winpercent, prefix="asia_")
aoe4_graficos(europe_d9_winpercent, prefix="europe_")
aoe4_graficos(middleeast_d9_winpercent, prefix="middleeast_")
aoe4_graficos(northamerica_d9_winpercent, prefix="northamerica_")
aoe4_graficos(southamerica_d9_winpercent, prefix="southamerica_")
aoe4_graficos(oceania_d9_winpercent, prefix="oceania_")
